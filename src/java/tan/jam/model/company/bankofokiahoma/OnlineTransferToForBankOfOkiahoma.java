 ...
 * @author Lenovo
 */
public class OnlineTransferToForBankOfOkiahoma {
    ...
    public OnlineTransferToForBankOfOkiahoma(List<String> initialBlock) {
    ...
    private void captureDateDescriptionAmount() {
        ...
        for (String s : list) {
            ...
            String res = FileUtils.getResultFromPattern("Account\\s+\\d+|CHKG\\s+\\d+", desc);
    ...
    private List<String> captureSelectedRecordsBlock() {
        ...
        for (String s : list) {
            String result = FileUtils.getResultFromPattern("Funds\\s+Transfer\\s+To|XFER\\s+TO", s);
