 ...
 * @author Lenovo
 */
public class DepositsForBBVACompass {
    ...
    public DepositsForBBVACompass(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<String> captureOnlineReversalFromRecords() {
        ...
        List<String> list = FileUtils.getSelectedRecord(this.selectedBlock, "CHECK\\s*RETURNED|REFUND|BOUNCE");
    ...
    private List<String> captureOnlineTransferFromRecords() {
        ...
        List<String> list = FileUtils.getSelectedRecord(this.selectedBlock, "ONLINE\\s*BANKING\\s*TRANSFER\\s*FR|TRANSFER\\s+FROM");
