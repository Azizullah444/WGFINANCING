 ...
 * @author Lenovo
 */
public class OnlineTransferToForUnionBank {
    ...
    public OnlineTransferToForUnionBank(List<String> initialBlock) {
    ...
    private void captureDateDescriptionAmount() {
        ...
        for (String s : list) {
            ...
            String res = FileUtils.getResultFromPattern("XXXX+\\d+", desc);
