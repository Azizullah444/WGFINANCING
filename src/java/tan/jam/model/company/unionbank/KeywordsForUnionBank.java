 ...
 * @author Lenovo
 */
public class KeywordsForUnionBank{
    ...
    public KeywordsForUnionBank(List<String> lines, List<String> words) {
        this.words = words;
        this.lines = lines;
    ...
    private List<String> captureDebitBlock() {
        String firstStart="^\\s*Payments\\s+online\\s+and\\s+electronic";
