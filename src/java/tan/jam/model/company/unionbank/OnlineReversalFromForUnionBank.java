 ...
 * @author Lenovo
 */
public class OnlineReversalFromForUnionBank {
    ...
    public OnlineReversalFromForUnionBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("REVERSAL|REFUND|RETURNED", s);
