 ...
 * @author Lenovo
 */
public class CredentialsForAstoriaBank {
    ...
    public CredentialsForAstoriaBank(String[] pages) {
        this.pages = pages;
    ...
    public CredentialsForAstoriaBank(String companyName) {
