 ...
 * @author Lenovo
 */
public class DebitsForAstoriaBank {

    private List<String> lines;
    private List<String> initialBlock;
    private List<String> selectedRecords;
    List<String> mergedLines = new ArrayList<>();
    private OnlineTransferToForAstoriaBank onlineTransferTo;
    

    public DebitsForAstoriaBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private void startExecution() {
        ...
        this.onlineTransferTo = new OnlineTransferToForAstoriaBank(initialBlock);
    }
    ...
    public OnlineTransferToForAstoriaBank getOnlineTransferTo() {
        return onlineTransferTo;
    }

    public void setOnlineTransferTo(OnlineTransferToForAstoriaBank onlineTransferTo) {
