 ...
 * @author Lenovo
 */
public class OnlineTransferToForAstoriaBank {
    ...
    public OnlineTransferToForAstoriaBank(List<String> initialBlock) {
    ...
    private List<String> captureSelectedRecordsBlock() {
        ...
        for (int a = 0; a < list.size(); a++) { 
            ...
            if (!result.startsWith("NoMatch") && list.get(a).matches("^\\s*\\d{1,2}-\\d{1,2}.+")) { 
