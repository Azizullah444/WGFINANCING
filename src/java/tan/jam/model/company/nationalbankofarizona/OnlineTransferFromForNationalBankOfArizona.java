 ...
 * @author Lenovo
 */
public class OnlineTransferFromForNationalBankOfArizona {
    ...
    public OnlineTransferFromForNationalBankOfArizona(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("ONLINE\\s+XFER\\s+FROM", s);
