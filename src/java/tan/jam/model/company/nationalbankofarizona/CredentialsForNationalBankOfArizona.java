 ...
 * @author Lenovo
 */
public class CredentialsForNationalBankOfArizona {
    ...
    public CredentialsForNationalBankOfArizona(String[] pages) {
        this.pages = pages;
