 ...
 * @author Lenovo
 */
public class OnlineTransferToForNationalBankOfArizona {
    ...
    public OnlineTransferToForNationalBankOfArizona(List<String> initialBlock) {
    ...
    private void captureDateDescriptionAmount() {
        ...
        for (String s : list) {
            ...
            String res = FileUtils.getResultFromPattern("Acct\\s+\\d+\\s*\\d+|Checking\\s+\\d+", desc);
    ...
    private List<String> captureSelectedRecordsBlock() {
        ...
        for (String s : list) { 
            String result = FileUtils.getResultFromPattern("ONLINE\\s+XFER\\s+TO", s);
