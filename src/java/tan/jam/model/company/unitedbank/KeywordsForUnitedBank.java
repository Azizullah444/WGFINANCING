 ...
 * @author Lenovo
 */
public class KeywordsForUnitedBank {
    ...
    public KeywordsForUnitedBank(List<String> lines, List<String> words) {
        this.words = words;
        this.lines = lines;
    ...
    private double extractAmountFromKeywordListAndReturnSum() {
        ...
        for (int a = 0; a < this.selectedBlock.size(); a++) {
            ...
            String value = FileUtils.getDollarSignRemovedValue(FileUtils.getNegativeSignDetectedValue(temp[temp.length-2]));
