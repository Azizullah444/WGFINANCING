 ...
 * @author Lenovo
 */
public class DepositsForUnitedBank {
    ...
    public DepositsForUnitedBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<String> captureOnlineReversalFromRecords() {
        ...
        List<String> list = FileUtils.getSelectedRecord(this.selectedBlock, "Reversal|REFUND|Bounce|Return");
