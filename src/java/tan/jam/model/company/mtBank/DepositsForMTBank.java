 ...
 * @author Lenovo
 */
public class DepositsForMTBank {
    ...
    public DepositsForMTBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<String> captureOnlineReversalFromRecords() {
        ...
        List<String> list = FileUtils.getSelectedRecord(this.selectedBlock, "REVERSAL|BOUNCE");
    ...
    private List<String> captureOnlineTransferFromRecords() {
        ...
        List<String> list = FileUtils.getSelectedRecord(this.selectedBlock, "XFER\\s+FROM|TRANSFER\\s+CREDIT");
