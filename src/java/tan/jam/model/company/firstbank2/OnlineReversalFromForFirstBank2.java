 ...
 * @author Lenovo
 */
public class OnlineReversalFromForFirstBank2 {
    ...
    public OnlineReversalFromForFirstBank2(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("RETURN|REVERSAL", s);
