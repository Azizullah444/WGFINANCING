 ...
 * @author Lenovo
 */
public class DailyLedgerBalanceForFirstBank2 {
    ...
    DailyLedgerBalanceForFirstBank2(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureSelectedBlock() {
        ...
        int endIndex = FileUtils.findIndexBySingleValue(lines, startIndex, "What\\s+is\\s+your\\s+retirement\\s+strategy");
        ...
        for (String s : temp) {
            ...
            for (int a = 0; a < result.length; a++) {
                ...
                if (!result1.startsWith("NoMatch") && a + 2 < result.length) {
