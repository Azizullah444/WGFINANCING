...
public class DailyLedgerBalanceForBankOfAmerica {
    ...
    public DailyLedgerBalanceForBankOfAmerica(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<String> captureSelectedBlock() {
        int startIndex = FileUtils.findIndexBySingleValue(lines, "Daily\\s+ledger\\s+balances");
        int endIndex = FileUtils.findIndexBySingleValue(lines, startIndex, "To\\s+help\\s+you\\s+BALANCE\\s+YOUR\\s+CHECKING\\s+ACCOUNT,|^\\s*Check\\s+images");
