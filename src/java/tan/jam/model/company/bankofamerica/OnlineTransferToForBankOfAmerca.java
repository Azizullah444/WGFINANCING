 ...
 * @author Lenovo
 */
public class OnlineTransferToForBankOfAmerca {
    ...
    public OnlineTransferToForBankOfAmerca(List<String> initialBlock) {
    ...
    private void captureDateDescriptionAmount() {
        ...
        for (String s : list) {
            ...
            String res = FileUtils.getResultFromPattern("CHK\\s+\\d{4}|Sav\\s+\\d+", desc);
