 ...
 * @author Lenovo
 */
public class CredentialsForBankOfTheOzarks{
    ...
    CredentialsForBankOfTheOzarks(String[] page,List<String> lines) {
        this.pages = page;
        this.lines = lines;
        startExecution();
    }
    ...
    private void startExecution() {
        this.companyName = "BankOfTheOzarks";
     ...
     private String captureDate() {
        ...
        for (int a = 0; a < lines.size(); a++) {
            String d = FileUtils.getResultFromPattern("\\d{2}/\\d{2}/\\d{2,4}", this.lines.get(a));
