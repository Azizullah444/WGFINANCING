 ...
 * @author Lenovo
 */
public class KeywordsForBankOfTheOzarks {
    ...
    public KeywordsForBankOfTheOzarks(List<String> lines, List<String> words) {
        this.words = words;
        this.lines = lines;
    ...
    private List<String> captureInitialBlock() {
       int startIndex = FileUtils.findIndexBySingleValue(lines, "\\*+\\s*CHECKING\\s+ACCOUNT\\s+TRANSACTIONS");
        int endIndex = FileUtils.findIndexBySingleValue(lines, "\\*+\\s*BALANCE\\s+BY\\s+DATE");
