 ...
 * @author Lenovo
 */
public class CredentialsForBMOHarrisBank {
    ...
    public CredentialsForBMOHarrisBank(String[] pages) {
        this.pages = pages;
    ...
    private String captureDate() {
        String result = FileUtils.getResultFromPattern("TO\\s+\\d{1,2}/\\d{1,2}/\\d{1,2}", pages[0]);
