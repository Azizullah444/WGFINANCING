 ...
 * @author Lenovo
 */
public class OnlineReversalFromForBMOHarrisBank {
    ...
    public OnlineReversalFromForBMOHarrisBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Refund|REFUND|RETURN|REVERSAL", s);
