 ...
 * @author Lenovo
 */
public class DebitsForBMOHarrisBank {

    private List<String> lines;
    private List<String> initialBlock;
    private List<String> selectedRecords;
    List<String> mergedLines = new ArrayList<>();
    private OnlineTransferToForBMOHarrisBank onlineTransferTo;
    

    public DebitsForBMOHarrisBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private void startExecution() {
        ...
        this.onlineTransferTo = new OnlineTransferToForBMOHarrisBank(initialBlock);
    }
    private List<String> captureInitialBlock() {
        String start = "^\\s*Withdrawals\\s+and\\s+Other\\s+Debits";
        String end = "^\\s*Checks\\s+by\\s+Serial\\s+Number|^\\s*Daily\\s+Balance\\s+Summary";
    ...
    public OnlineTransferToForBMOHarrisBank getOnlineTransferTo() {
        return onlineTransferTo;
    }

    public void setOnlineTransferTo(OnlineTransferToForBMOHarrisBank onlineTransferTo) {
