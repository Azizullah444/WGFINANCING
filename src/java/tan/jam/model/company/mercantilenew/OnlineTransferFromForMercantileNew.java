 ...
 * @author Lenovo
 */
public class OnlineTransferFromForMercantileNew {
    ...
    public OnlineTransferFromForMercantileNew(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Trsfr", s);
