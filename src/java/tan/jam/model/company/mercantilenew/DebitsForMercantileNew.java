 ...
 * @author Lenovo
 */
public class DebitsForMercantileNew {

    private List<String> lines;
    private List<String> initialBlock;
    private List<String> selectedRecords;
    List<String> mergedLines = new ArrayList<>();
    private OnlineTransferToForMercantileNew onlineTransferTo;
    

    public DebitsForMercantileNew(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private void startExecution() {
        ...
        this.onlineTransferTo = new OnlineTransferToForMercantileNew(initialBlock);
    }
    ...
    public OnlineTransferToForMercantileNew getOnlineTransferTo() {
        return onlineTransferTo;
    }

    public void setOnlineTransferTo(OnlineTransferToForMercantileNew onlineTransferTo) {
