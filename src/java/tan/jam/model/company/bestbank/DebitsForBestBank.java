 ...
 * @author Lenovo
 */
public class DebitsForBestBank {

    private List<String> lines;
    private List<String> initialBlock;
    private List<String> selectedRecords;
    List<String> mergedLines = new ArrayList<>();
    private OnlineTransferToForBestBank onlineTransferTo;
    

    public DebitsForBestBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private void startExecution() {
        ...
        this.onlineTransferTo = new OnlineTransferToForBestBank(initialBlock);
    }
    private List<String> captureInitialBlock() {
        String start = "^\\s*DEBITS";
        String end = "^\\s*CREDITS";
    ...
    public OnlineTransferToForBestBank getOnlineTransferTo() {
        return onlineTransferTo;
    }

    public void setOnlineTransferTo(OnlineTransferToForBestBank onlineTransferTo) {
