 ...
 * @author Lenovo
 */
public class KeywordsForAcademyBank{
    ...
    public KeywordsForAcademyBank(List<String> lines, List<String> words) {
        this.words = words;
        this.lines = lines;
    ...
    private List<String> captureInitialBlock() {
       ...
       return  FileUtils.getSelectedBlock(lines, "^\\s*Account\\s+Activity", "^\\s*Daily\\s+Balances");
