 ...
 * @author Lenovo
 */
public class OnlineTransferToForParadiseBank {
    ...
    public OnlineTransferToForParadiseBank(List<String> initialBlock) {
    ...
    private void captureDateDescriptionAmount() {
        ...
        for (String s : list) {
            ...
            String res = FileUtils.getResultFromPattern("Chk ...?\\d{4}", desc);
    ...
    private List<String> captureSelectedRecordsBlock() {
        ...
        for (String s : list) {
            String result = FileUtils.getResultFromPattern("Online Transfer To", s);
