 ...
 * @author Lenovo
 */
public class OnlineTransferFromForParadiseBank {
    ...
    public OnlineTransferFromForParadiseBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Online Transfer From", s);
