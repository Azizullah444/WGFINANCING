 ...
 * @author Lenovo
 */
public class DebitsForSiliconValleyBank {
    ...
    public DebitsForSiliconValleyBank(List<String> lines) {
        this.lines = lines;
        date = new ArrayList<>();
    ...
    private void captureOnlineTransferToRecords() {
        ...
        for (int a = 0; a < this.selectedBlock.size(); a++) {
            String result = FileUtils.getResultFromPattern("ONLINE\\s+TRANSFER\\s+WITHDRAWAL", this.selectedBlock.get(a));
