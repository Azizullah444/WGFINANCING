 ...
 * @author Lenovo
 */
public class DailyLedgerBalanceForFirstNationalBank {
    ...
    DailyLedgerBalanceForFirstNationalBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
...
private List<Double> captureSelectedBlock() {
        int startIndex = FileUtils.findIndexBySingleValue(lines,"D A I L Y  B A L A N C E  I N F O R M A T I O N");
        int endIndex = FileUtils.findIndexBySingleValue(lines,"-----------------------------------------------------------------------------");
