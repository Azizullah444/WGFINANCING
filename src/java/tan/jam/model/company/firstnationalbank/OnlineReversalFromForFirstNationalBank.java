 ...
 * @author Lenovo
 */
public class OnlineReversalFromForFirstNationalBank {
    ...
    public OnlineReversalFromForFirstNationalBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Refund|REFUND|RETURNED", s);
