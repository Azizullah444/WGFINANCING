 ...
 * @author Lenovo
 */
public class OnlineTransferFromForFirstNationalBank {
    ...
    public OnlineTransferFromForFirstNationalBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("ONLINE\\s+XFR\\s+FRM", s);
