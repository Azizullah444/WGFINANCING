 ...
 * @author Lenovo
 */
public class OnlineTransferToForFirstNationalBank {
    ...
    public OnlineTransferToForFirstNationalBank(List<String> initialBlock) {
    ...
    private void captureDateDescriptionAmount() {
        ...
        for (String s : list) {
            ...
            String res = FileUtils.getResultFromPattern("XXX\\d+", desc);
