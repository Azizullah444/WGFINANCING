 ...
 * @author Lenovo
 */
public class OnlineReversalFromForFirstBank {
    ...
    public OnlineReversalFromForFirstBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("REVERSE|REFUND|RETURNED", s);
