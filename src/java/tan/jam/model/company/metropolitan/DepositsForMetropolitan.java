 ...
 * @author Lenovo
 */
public class DepositsForMetropolitan {
    ...
    public DepositsForMetropolitan(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<String> captureOnlineTransferFromRecords() {
        ...
        List<String> list = FileUtils.getSelectedRecord(this.selectedBlock, "MINIMUM\\s+BALANCE\\s+TRANSFER");
