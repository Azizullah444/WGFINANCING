 ...
 * @author Lenovo
 */
public class OnlineTransferFromForCitiBank {
    private List<String> lines;
    private List<String> selectedBlock;
    private List<Double> selectedAmountBlock;
    private double sum;

    public OnlineTransferFromForCitiBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<String> captureSelectedBlock(){
        ...
        for(String s: list){
            String result = FileUtils.getResultFromPattern("TRANSFER\\s+CREDIT", s);
