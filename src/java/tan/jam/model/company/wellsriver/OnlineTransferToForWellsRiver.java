 ...
 * @author Lenovo
 */
public class OnlineTransferToForWellsRiver {
    ...
    public OnlineTransferToForWellsRiver(List<String> initialBlock) {
    ...
    private void captureDateDescriptionAmount() {
        ...
        for (String s : list) {
            ...
            String res = FileUtils.getResultFromPattern("checking\\s+\\d+|savings\\s+\\d+", desc);
