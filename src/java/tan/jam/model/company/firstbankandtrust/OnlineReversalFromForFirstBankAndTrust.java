 ...
 * @author Lenovo
 */
public class OnlineReversalFromForFirstBankAndTrust {
    ...
    public OnlineReversalFromForFirstBankAndTrust(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Reverse|Refund|RETURN|RTN", s);
