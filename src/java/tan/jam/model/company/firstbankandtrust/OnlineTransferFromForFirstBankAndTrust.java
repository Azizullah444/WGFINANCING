 ...
 * @author Lenovo
 */
public class OnlineTransferFromForFirstBankAndTrust {
    ...
    public OnlineTransferFromForFirstBankAndTrust(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Transf\\s+from", s);
