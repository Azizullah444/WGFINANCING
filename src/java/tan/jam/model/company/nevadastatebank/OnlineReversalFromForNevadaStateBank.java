 ...
 * @author Lenovo
 */
public class OnlineReversalFromForNevadaStateBank {
    ...
    public OnlineReversalFromForNevadaStateBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Reverse|Refund|Return|REFUNDS|RETURN", s);
