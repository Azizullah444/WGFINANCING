 ...
 * @author Lenovo
 */
public class OnlineTransferToForNevadaStateBank {
    ...
    public OnlineTransferToForNevadaStateBank(List<String> initialBlock) {
    ...
    private List<String> captureSelectedRecordsBlock() {
        ...
        for (String s : list) { 
            String result = FileUtils.getResultFromPattern("Online\\s+Transfer\\s+Debit", s);
