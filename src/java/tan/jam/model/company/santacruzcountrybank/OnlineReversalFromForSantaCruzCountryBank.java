 ...
 * @author Lenovo
 */
public class OnlineReversalFromForSantaCruzCountryBank {
    private List<String> lines;
    private List<String> filteredBlock;
    private List<Double> amountBlock;
    private double sum;

    public OnlineReversalFromForSantaCruzCountryBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Reversal|Return|Bounce", s);
