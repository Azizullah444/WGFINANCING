 ...
 * @author Lenovo
 */
public class OnlineTransferFromForSantaCruzCountryBank {
    ...
    public OnlineTransferFromForSantaCruzCountryBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("IB\\s+Transfer\\s+Deposit", s);
