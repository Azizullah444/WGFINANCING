 ...
 * @author Lenovo
 */
public class OnlineTransferToForUSBank {
    ...
    public OnlineTransferToForUSBank(List<String> initialBlock) {
    ...
    private List<String> captureSelectedRecordsBlock() {
        ...
        for (String s : list) {
            String result = FileUtils.getResultFromPattern("Mobile\\s+Banking\\s+Transfer\\s+To|Internet\\s+Banking\\s+Transfer\\s+To", s);
