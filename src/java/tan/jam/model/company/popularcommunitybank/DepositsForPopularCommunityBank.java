 ...
 * @author Lenovo
 */
public class DepositsForPopularCommunityBank {
    ...
    public DepositsForPopularCommunityBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<String> captureOnlineTransferFromRecords() {
        ...
        List<String> list = FileUtils.getSelectedRecord(this.selectedBlock, "Trsfr\\s+Cr");
