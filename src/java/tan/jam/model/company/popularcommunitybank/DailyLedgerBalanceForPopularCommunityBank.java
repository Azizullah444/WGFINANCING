 ...
 * @author Lenovo
 */
public class DailyLedgerBalanceForPopularCommunityBank {
    ...
    public DailyLedgerBalanceForPopularCommunityBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private double findAverageValues() {
         ...
         double d = 0;
       for(String s: lines){
           if(s.matches("Average\\s+balance.+")){
               result = s;
               break;
           }
       }
