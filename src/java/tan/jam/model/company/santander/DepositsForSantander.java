 ...
 * @author Lenovo
 */
public class DepositsForSantander {
    ...
    public DepositsForSantander(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<String> captureOnlineTransferFromRecords() {
        ...
        List<String> list = FileUtils.getSelectedRecord(this.selectedBlock, "Online\\s*Transfer\\s*From|INTERNET\\s*TRANSFER\\s*FROM");
