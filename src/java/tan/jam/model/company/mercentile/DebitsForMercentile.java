 ...
 * @author Lenovo
 */
public class DebitsForMercentile {

    private List<String> lines;
    private List<String> initialBlock;
    private List<String> selectedRecords;
    List<String> mergedLines = new ArrayList<>();
    private OnlineTransferToForMercentile onlineTransferTo;
    

    public DebitsForMercentile(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private void startExecution() {
        ...
        this.onlineTransferTo = new OnlineTransferToForMercentile(initialBlock);
    }
    private List<String> captureInitialBlock() {
        String start = "- - -\\s*OTHER\\s+DEBITS";
        String end = "- - -\\s*DAILY\\s+BALANCE";
    ...
    public OnlineTransferToForMercentile getOnlineTransferTo() {
        return onlineTransferTo;
    }

    public void setOnlineTransferTo(OnlineTransferToForMercentile onlineTransferTo) {
