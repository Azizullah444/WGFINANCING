 ...
 * @author Lenovo
 */
public class CredentialsForMercentile {
    ...
    public CredentialsForMercentile(String[] pages) {
        this.pages = pages;
    ...
    private String captureDate() {
        String result = FileUtils.getResultFromPattern("\\d{2}/\\d{2}/\\d{4}", pages[0]);
        return result;
    }
