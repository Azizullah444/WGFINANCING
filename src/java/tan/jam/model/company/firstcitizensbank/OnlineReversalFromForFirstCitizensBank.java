 ...
 * @author Lenovo
 */
public class OnlineReversalFromForFirstCitizensBank {
    private List<String> lines;
    private List<String> filteredBlock;
    private List<Double> amountBlock;
    private double sum;

    public OnlineReversalFromForFirstCitizensBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Reversal|Bounce|Return|Rtrn|REVERSAL|BOUNCE|RETURN|RTRN", s);
