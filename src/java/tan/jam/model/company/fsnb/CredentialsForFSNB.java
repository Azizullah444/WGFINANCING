 ...
 * @author Lenovo
 */
public class CredentialsForFSNB{
    ...
    CredentialsForFSNB(String[] page,List<String> lines) {
        this.pages = page;
        this.lines = lines;
        startExecution();
    }
    ...
    private void startExecution() {
     ...
     private String captureDate() {
      ...
      private String captureAccountNumber() {
        String result = FileUtils.getTargetByMatch(pages[0], "Account\\s+X+\\d+");
