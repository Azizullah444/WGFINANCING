...
public class DepositsForFSNB {
    ...
    public DepositsForFSNB(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<String> captureOnlineReversalFromRecords() {
        ...
        List<String> list = FileUtils.getSelectedRecord(this.selectedBlock, "Reversal|REFUND|Bounce|Return\\s+Item\\s+Credit");
