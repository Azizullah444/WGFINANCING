 ...
 * @author Lenovo
 */
public class OnlineTransferFromForCentralBank {
    ...
    public OnlineTransferFromForCentralBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("IB\\s+TFR\\s+FR", s);
