 ...
 * @author Lenovo
 */
public class DailyLedgerBalanceForCitizenBank {
    ...
    DailyLedgerBalanceForCitizenBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
...
private List<Double> captureSelectedBlock() {
        ...
        int endIndex = FileUtils.findIndexBySingleValue(lines, "images\\s+for\\s+account|^\\s*Checking\\s+Account\\s+Balance\\s+Worksheet");
