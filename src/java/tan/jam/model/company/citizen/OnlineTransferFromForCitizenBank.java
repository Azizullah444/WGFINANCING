 ...
 * @author Lenovo
 */
public class OnlineTransferFromForCitizenBank {
    ...
    public OnlineTransferFromForCitizenBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Transfer\\s+From", s);
