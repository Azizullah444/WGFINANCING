 ...
 * @author Lenovo
 */
public class OnlineTransferFromForHuntington {
    ...
    public OnlineTransferFromForHuntington(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("ONL\\s+TFR\\s+FRM|INTERNET\\s+TFR\\s+FRM", s);
