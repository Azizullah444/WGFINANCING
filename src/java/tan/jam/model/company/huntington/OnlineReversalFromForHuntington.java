 ...
 * @author Lenovo
 */
public class OnlineReversalFromForHuntington {
    ...
    public OnlineReversalFromForHuntington(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("REVERSE|\\s+RET\\s+|RETURNED|Refund|Return", s);
