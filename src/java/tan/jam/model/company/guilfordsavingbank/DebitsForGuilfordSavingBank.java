 ...
 * @author Lenovo
 */
public class DebitsForGuilfordSavingBank {

    private List<String> lines;
    private List<String> initialBlock;
    private List<String> selectedRecords;
    List<String> mergedLines = new ArrayList<>();
    private OnlineTransferToForGuilfordSavingBank onlineTransferTo;
    

    public DebitsForGuilfordSavingBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private void startExecution() {
        ...
        this.onlineTransferTo = new OnlineTransferToForGuilfordSavingBank(initialBlock);
    }
    private List<String> captureInitialBlock() {
        String start = "^\\s*Checks/Debits";
        String end = "^\\s*Total\\s+Checks/Debits";
    ...
    public OnlineTransferToForGuilfordSavingBank getOnlineTransferTo() {
        return onlineTransferTo;
    }

    public void setOnlineTransferTo(OnlineTransferToForGuilfordSavingBank onlineTransferTo) {
