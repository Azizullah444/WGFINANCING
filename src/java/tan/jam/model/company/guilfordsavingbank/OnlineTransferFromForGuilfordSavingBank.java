 ...
 * @author Lenovo
 */
public class OnlineTransferFromForGuilfordSavingBank {
    ...
    public OnlineTransferFromForGuilfordSavingBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("INTERNET\\s+TFR\\s+FRM", s);
