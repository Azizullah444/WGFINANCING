...
public class CredentialsForAmericanEagle{
    ...
    CredentialsForAmericanEagle(String[] page,List<String> lines) {
        this.pages = page;
        this.lines = lines;
        startExecution();
    }
    ...
    private void startExecution() {
        this.companyName = "AmericanEagle"; 
     ...
     private double captureTotalDeposits() {
         ...
         double d = 0;
       for(String s: lines){
           if(s.matches("^\\s*Total\\s+Deposits.+")){
               result = s;
     ...
     private String captureDate() {
        ...
        for (int a = 0; a < lines.size(); a++) {
            String d = FileUtils.getResultFromPattern("Statement\\s+Period.+", this.lines.get(a));
