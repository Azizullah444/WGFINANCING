 ...
 * @author Lenovo
 */
public class CredentialsForSeawayBank {
    ...
    public CredentialsForSeawayBank(String[] pages) {
        this.pages = pages;
    ...
    public CredentialsForSeawayBank(String companyName) {
