 ...
 * @author Lenovo
 */
public class DepositsForPeopleUnited {
    ...
    public DepositsForPeopleUnited(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<String> captureOnlineTransferFromRecords() {
        ...
        List<String> list = FileUtils.getSelectedRecord(this.selectedBlock, "Online\\s+Xfr\\s+IN");
