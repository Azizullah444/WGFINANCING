 ...
 * @author Lenovo
 */
public class DebitsForPeopleUnited {
    ...
    public DebitsForPeopleUnited(List<String> lines) {
        this.lines = lines;
        date = new ArrayList<>();
    ...
    private void captureOnlineTransferToRecords() {
        ...
        for (int a = 0; a < this.selectedBlock.size(); a++) {
            String result = FileUtils.getResultFromPattern("Online\\s+Xfr\\s+Out", this.selectedBlock.get(a));
