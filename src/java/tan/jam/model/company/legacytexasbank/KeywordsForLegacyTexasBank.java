 ...
 * @author Lenovo
 */
public class KeywordsForLegacyTexasBank{
    ...
    public KeywordsForLegacyTexasBank(List<String> lines, List<String> words) {
        this.words = words;
        this.lines = lines;
    ...
    private double extractAmountFromKeywordListAndReturnSum() {
        ...
        for (int a = 0; a < selectedBlock.size(); a++) {
            ...
            String value = FileUtils.getDollarSignRemovedValue(FileUtils.getNegativeSignDetectedValue(FileUtils.getCRRemovedValue(temp[temp.length-2],selectedBlock.get(a))));
