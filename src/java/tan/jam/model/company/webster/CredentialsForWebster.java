 ...
 * @author Lenovo
 */
public class CredentialsForWebster{
    ...
    CredentialsForWebster(String[] page,List<String> lines) {
        this.pages = page;
        this.lines = lines;
        startExecution();
    }
    ...
    private void startExecution() {
     ...
     private String captureDate() {        
        ...
        for (int a = 0; a < lines.size(); a++) {
            String d = FileUtils.getResultFromPattern("through\\s+\\D+\\s+\\d{1,2},\\s+\\d{4}", this.lines.get(a));
