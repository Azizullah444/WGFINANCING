 ...
 * @author Lenovo
 */
public class KeywordsForWebster{
    ...
    public KeywordsForWebster(List<String> lines, List<String> words) {
        this.words = words;
        this.lines = lines;
    ...
    private List<String> captureInitialBlock() {
       ...
       return  FileUtils.getSelectedBlock(lines, "Date\\s+Description\\s+Credits\\s+Debits\\s+Balance", "^\\s*Totals");
