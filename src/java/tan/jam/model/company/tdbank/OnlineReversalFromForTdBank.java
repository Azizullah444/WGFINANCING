 ...
 * @author Lenovo
 */
public class OnlineReversalFromForTdBank {
    ...
    public OnlineReversalFromForTdBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
          //  System.out.println("row "+s);
            String result = FileUtils.getResultFromPattern("Refund|REFUND|Return|RETURN", s);
