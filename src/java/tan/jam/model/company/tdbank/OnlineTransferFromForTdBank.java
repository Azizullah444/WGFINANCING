 ...
 * @author Lenovo
 */
public class OnlineTransferFromForTdBank {
    ...
    public OnlineTransferFromForTdBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
           // System.out.println("row "+s);
            String result = FileUtils.getResultFromPattern("e\\s?+Transfer\\s+Credit", s);
