 ...
 * @author Lenovo
 */
public class OnlineTransferFromForFifthThirdBank {
    ...
    public OnlineTransferFromForFifthThirdBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
    ...
    private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("ONLINE\\s+TRANSFER\\s+FROM", s);
