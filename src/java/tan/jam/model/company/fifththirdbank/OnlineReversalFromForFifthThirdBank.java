 ...
 * @author Lenovo
 */
public class OnlineReversalFromForFifthThirdBank {
    ...
    public OnlineReversalFromForFifthThirdBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("REVERSE|RETURN", s);
