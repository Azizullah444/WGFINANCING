 ...
 * @author Lenovo
 */
public class OnlineTransferToForFifthThirdBank {
    ...
    public OnlineTransferToForFifthThirdBank(List<String> initialBlock) {
    ...
    private void captureDateDescriptionAmount() {
        ...
        for (String s : list) {
            ...
            String res = FileUtils.getResultFromPattern("XX\\d+", desc);
    ...
    private List<String> captureSelectedRecordsBlock() {
        ...
        for (String s : list) { 
            String result = FileUtils.getResultFromPattern("ONLINE\\s+TRANSFER\\s+TO", s);
