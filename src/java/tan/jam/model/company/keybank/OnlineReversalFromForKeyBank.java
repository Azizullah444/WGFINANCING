 ...
 * @author Lenovo
 */
public class OnlineReversalFromForKeyBank {
    ...
    public OnlineReversalFromForKeyBank(List<String> lines) {
        this.lines = lines;
        startExecution();
    }
   ...
   private List<Double> captureAmountFromSelectedRecords() {
        ...
        for (String s : this.filteredBlock) {
            String result = FileUtils.getResultFromPattern("Bounce|Refund|Returned", s);
